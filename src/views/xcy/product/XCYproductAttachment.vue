<template>
  <div class="app-container">
    ...
    <cwindow :title="wintitle" v-model="winvisible">
      <div class="page-controlstyle"></div>
...
export default {
  ...
  methods: {
    ...
    showEdit(row) {
      let that = this;
      u.openeditmodel(this, xcy.getProductAttachment, row);
    },
    doDelete() {
      u.deleteoperate(this, xcy.deleteProductAttachment);
    },
    doExport() {
    ...
    doSave() {
      //保存
      u.doSave(this, xcy.saveProductAttachment);
    }
  }
}
</script>
