  ...
  <div class="app-container">
    ...
    <cwindow :title="wintitle" v-model="winvisible">
      <div class="page-controlstyle">
        <cinput :required="true" title="名称" v-model="mm.game_name"></cinput>
        <cinput :required="true" title="标签" v-model="mm.game_tag"></cinput>
    ...
    doQuery(querylist) {
      ...
      if (querylist === undefined) {
        if (u.isnullorwhitespace(this.queryvalue)) {
          ...
          this.querylist = [];
          u.addwheres(this, "and", "(", "gms_game.game_name", "like", this.queryvalue, "");
          u.addwheres(this, "or", "", "gms_game.game_tag", "like", this.queryvalue, ")");
        }
      } else {
