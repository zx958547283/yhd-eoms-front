  ...
  <div class="app-container">
    ...
    <cwindow :title="wintitle" v-model="winvisible">
      <div class="page-controlstyle">
        <cinput :required="true" title="服务器名称" v-model="mm.server_name"></cinput>
        <cinput :required="true" title="服务器位置" v-model="mm.server_position"></cinput>
        <cinput :required="true" title="服务器标志" v-model="mm.server_tag"></cinput>
        <cinput :required="true" title="服务器ip地址" v-model="mm.server_ip"></cinput>
        <cinput :required="true" title="端口" v-model="mm.server_port"></cinput>
        <cnumber :required="true" title="可承载人数" v-model="mm.max_user_count"></cnumber>
        <cnumber :required="true" title="服务器已有人数" v-model="mm.online_count"></cnumber>
        <cinput :length="2" title="备注" v-model="mm.remarks"></cinput>
        <cselect :required="true" querypk="804c6597-c9f3-479b-9ea8-21681cb45e04" title="所属游戏" v-model="mm.game_guid"></cselect>
        <cselect :required="true" pk="online" title="状态" v-model="mm.status"></cselect>
      </div>
