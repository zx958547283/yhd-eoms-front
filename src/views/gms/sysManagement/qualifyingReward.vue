  ...
  <div class="app-container">
    ...
    <cwindow :title="wintitle" v-model="winvisible">
      <div class="page-controlstyle">
        <cinput title="赛季名称" v-model="mm.qualifying_name"></cinput>
        <csuploadWithPath :dataObj="updatePath" :length="2" title="赛季说明" v-model="mm.qualifying_desc"></csuploadWithPath>
        <div class="datepick">
          <span class="datepick_txt">日期</span>
        ...
        <cnumber :required="true" title="可游戏次数" v-model="mm.maxGameTime"></cnumber>
        <cnumber title="可参与人数" v-model="mm.maxJoinPlayer"></cnumber>
        <cnumber title="状态(备用)" v-model="mm.status"></cnumber>
        <cselect pk="qatype_level" title="游戏标签" v-model="mm.game_tag"></cselect>
      </div>
