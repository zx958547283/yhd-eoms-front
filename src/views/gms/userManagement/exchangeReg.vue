  ...
  <div class="app-container">
    <el-container>
      <el-container>
        ...
        <el-main>
          <ctable :data="tabledata" :pagenum="pagenum" @pagechange="dataLoad" @row-dblclick="gotoOrder" @selection-change="tableSelect"></ctable>
        </el-main>
      </el-container>
    </el-container>
  </div>
    ...
    doQuery(querylist) {
      if (querylist === undefined) {
        if (u.isnullorwhitespace(this.queryvalue)) {
          ...
          u.addwheres(this, "or", "", "ums_member.nickname", "like", this.queryvalue, ")");
        }
      } else {
