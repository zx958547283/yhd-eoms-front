    ...
    <el-container>
      ...
      <el-container>
        <el-header style="height:30px;">
          ...
          <cinputquery @query="btnquery()" placeholder="编码、名称、值" v-model="queryvalue"></cinputquery>
        </el-header>
        <el-main>
  ...
  methods: {
    doQuery(treeNode) {
      ...
      if (treeNode) {
        ...
        u.addwhere(this, "sys_def_list.def_id", treeNode.id, "querylist");
      }
      else {
        u.addwheres(this, "and", "(", "sys_def_list.code", "like", this.queryvalue, "");
