  ...
  methods: {
    ...
    handleSelectDialogConfirm() {
      ...
      this.$confirm('使用要进行添加操作?', '提示', {
        ...
        sms.addHomeSubjectRecommendBatch({ selectSubjects: selectSubjects }).then(response => {
    ...
    handleUpdateSort() {
      this.$confirm('是否要修改排序?', '提示', {
        ...
        sms.updateSubjectRecommendSort(this.sortDialogData).then(response => {
    ...
    getList() {
      ...
      sms.getHomeSubjectRecommendList(this.listQuery).then(res => {
    ...
    updateRecommendStatusStatus(ids, status, exc_keys) {
      this.$confirm('是否要修改推荐状态?', '提示', {
        ...
        sms.updateSubjectRecommendStatus({
          ids: ids,
          exc_keys: exc_keys,
          status: status
        }).then(response => {
    ...
    deleteSubject(ids) {
      this.$confirm('是否要删除该推荐?', '提示', {
        ...
        sms.deleteSubjectRecommendProduct({ pk: ids.join(",") }).then(response => {
          this.getList();
          this.$message({
            type: 'success',
            message: '删除成功!'
    ...
    getDialogList() {
      common.getSubjectList(this.dialogData.listQuery).then(res => {
