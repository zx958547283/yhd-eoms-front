  ...
  <div class="app-container">
    ...
    <cwindow :title="wintitle" v-model="winvisible">
      <div class="page-controlstyle">
        ...
        <cselect :required="true" pk="company" title="组织类型" v-model="mm.org_type"></cselect>
        <ccorp :required="true" title="上级" v-model="mm.parent_id"></ccorp>
        ...
        <cinput title="负责人姓名" v-model="mm.manager_name"></cinput>
        <cinput title="负责人电话" v-model="mm.manager_tel"></cinput>
        <cinput title="负责人手机" v-model="mm.manager_mobile"></cinput>
      </div>
