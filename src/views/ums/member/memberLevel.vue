  ...
  <div class="app-container">
    ...
    <cwindow :title="wintitle" v-model="winvisible">
      <div class="page-controlstyle">
        ...
        <csuploadWithPath :dataObj="updatePath" :length="2" title="等级图标" v-model="mm.icon"></csuploadWithPath>
      </div>
...
export default {
  data() {
    return {
      ...
      querylist: [],          //查询条件模板
      updatePath: {
        path: process.env.QB_LEVEL_UPLOAD_PATH
      }
    }
  },
  mounted() {
  ...
  methods: {
    ...
    showEdit(row) {
      let that = this;
      u.openeditmodel(this, ums.getMemberLevel, row);
    },
    doDelete() {
      u.deleteoperate(this, ums.deleteMemberLevel);
    },
    doExport() {
    ...
    doSave() {
      u.doSave(this, ums.saveMemberLevel);
    }
  }
}
</script>
