<template>
  <div class="order_line">
    ...
    <el-dialog title="客户选择" :visible.sync="winvisible" :close-on-click-modal="false" :modal-append-to-body="false">
      <el-button-group>
...
export default {
  ...
  methods: {
    ...
    btndataload: function(num) {
      ...
      u.querywhere(
        that,
        "aafab34f-94f9-4b02-9357-a78b01091af1",
        that.querylist,
        this.pagesize,
        that.pagenum,
        "tabledata"
