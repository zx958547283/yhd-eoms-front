<template>
  <div>
    <svg :class="{'is-active':isActive}" @click="toggleClick" class="hamburger" height="64" p-id="1691" style t="1492500959545" version="1.1" viewBox="0 0 1024 1024" width="64" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
